...
function StudentModal({ fn, studentID }) {
    ...
    const editStudent = async () => {
        if (inp1 || inp2 || inp3 || inp4 || inp5 || inp6) {
            let user = {
                ...
                parentsNumber: inp6.current.value.length === 0 ? undefined : inp6.current.value
            }
            console.log(user);
            let res = await axios.put(`${config.url}/admin/students/${studentID}`, user, {
                headers: {
                    ...
                    <div className="w-full px-6 py-6 lg:px-8 flex flex-col">
                        ...
                        <form className="flex flex-col items-center gap-12">
                            ...
                            <div className="flex items-center gap-12">
                                ...
                                <div className="w-full">
                                    <input ref={inp6} type="number" id="simple-search" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Parents Number" required />
                                </div>
                            </div>
                            <button onClick={editStudent} type="button"
